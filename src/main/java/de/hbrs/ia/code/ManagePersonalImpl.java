...
public class ManagePersonalImpl implements ManagePersonal {
    ...
    public List<SocialPerformanceRecord> readSocialPerformanceRecord(SalesMan salesMan) {
        ...
        for (Document doc : socialperformancecollection.find(new Document("salesmanId", salesMan.getId()))) {
    ...
    public void deleteSocialPerformanceRecord(SocialPerformanceRecord record, SalesMan salesMan) {
        socialperformancecollection.deleteOne(new Document("year", record.getYear())
                .append("performance", record.getPerformance())
                .append("salesmanId", salesMan.getId())); // salesMan wird benötigt, um die Zuordnung herzustellen
    }
